...
#define SANS_VERSION "2.8_2"    // SANS ambages
...
void generate_output(const uint64_t& num, multimap_<double, color_t>& split_list, hash_map<color_t, array<uint32_t,2>>& color_table, const string output, const string nexus, const string pdf, const string svg, const string raw, const bool nexus_wanted, const bool c_nexus_wanted, const bool pdf_wanted, const bool svg_wanted, const bool raw_wanted, const string groups, const string coloring, const uint32_t& bootstrap_no, hash_map<color_t, uint32_t>* support_values, vector<string> denom_names, const int denom_file_count, const bool verbose);
