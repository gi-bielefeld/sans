...
This document contains the html usage guide for SANS in the CloWM environment)
-->
...
<body>
  ...
  <!-- TOP BAR -->
  <!-- This block defines the orange bar at the left top of the window -->
  ...
  <div id="tocFrame" class="tocFrame">
    ...
    <div id="tocBody" class="tocBody">
      ...
      <div id="tocINList" class="tocList">
      </div>
      <br>
      ...
      <div id="tocQSList" class="tocList">
        <ol>
          <!--QSPD_anchor -->
          <li id="tocQSData" class="tocEntry">
            <a href=#preparing-data>Preparing Data</a>
          </li>
          
          <!--QSRW_anchor -->
          <li id="tocQSWorkflow" class="tocEntry">
            <a href=#running-a-workflow>Running a Workflow</a>
          </li>

          <!--QSRW_anchor -->
          <li id="tocQSResults" class="tocEntry">
            <a href=#accessing-results>Accessing Results</a>
          </li>
        </ol>
      </div>
    ...
    <ol id="tocAPList" class="tocList">
    </ol>

    <br>

    <div id=tocIG class="tocEntry" onclick=tocExpandChapter(tocIGList)>
      <a href=#installtion-guide>Installation Guide</a>
    </div>

    <ol id="tocIGList" class="tocList">
    </ol>
  ...
  <!-- START OF THE CONTENT DOCUMENT -->
  <div id="masterFrame" class="masterFrame">


    <!-- INTRODUCTION CHAPTER -->
    <div class="sectionFrame" onmouseenter=tocEnterChapter(tocIN) onmouseleave=tocUnmark(tocIN)>
      ...
      <h1 id="introduction" align="left">Introduction</h1>


      <!-- Introduction Text -->
      The <em>SANS ambages</em> software provides an easy way of phylogenomic reconstruction, 
      including a pipeline for immediate output rendering via 
      the tool <i>Splits Tree </i>. 
      The software comes with an extensive set of parameters and features, 
      allowing for applicability to a wide range of scenarios.
      In the following, we provide a set of explanations and examples of how to configure and stage a SANS workflow, 
      using the CloWM environment. 

      <br><br>

    <!-- End of the introduction frame-->
    </div> 
    ...
    <div class=sectionFrame onmouseenter=tocEnterChapter(tocQS) onmouseleave=tocUnmark(tocQS)>
      <span class="inlineBox">
        <br><br>
        <span align="left">
          <h1 id="quickstart-guide" align="left">Quickstart Guide</h1>
        </span>
      </span>
      <br>


      <!-- Quickstat introduction text-->
    ...
    <!-- End of the quickstart sectionFrame -->
    </div>


    <!-- Quickstart: PREPARING DATA SECTION -->
    <!-- QSPD_anchor -->
    <div class=sectionFrame onmouseenter=tocEnterSection(tocQS,tocQSData) onmouseleave=tocUnmark(tocQSData)>
      ...
      <!-- 
      SLIDESHOW: 'Quickstart-Preparing Data' alias QSPD
      The following block defines the bucket and folder slideshow of the data preparation section
      This skript controlls the QSBucketSlideshow
      -->
      <!-- QSPD_anchor -->
      ...
      <script>
        ...
        /*The collapse Slide function destructs the skript of slides and recreates the slideshow*/
      ...
      <!-- 
      Start of the slideshow content
      All content of the slideshow is contained in the corresponding container div 
      -->
      <!-- QSPD_anchor -->
      ...
      <!-- 
      Slide 1 is the cover of the slideshow)
      The first slide uses the coverSlide class that is shown by default
      All other slides use the slice class and are thus hidden by default
      Each slide contains an image, a control pannel and a textbox 
      -->
      <div id="QSPD_slide1" class=coverSlide>


        <!-- The image of this slide -->
        <div class=imageBox>
          <img alt="QS_Preparing_Data_1_1" width="80%" src="https://gitlab.ub.uni-bielefeld.de/api/v4/projects/1302/repository/files/docs%2Fresource%2Fquickstart%2F1_1.png/raw?ref=clowm-integration-extensions">
        </div>


        <!-- Control panel of this slide -->
      ...
      <div id="QSPD_slide2" class=slide>
        ...
        <!-- The image of this slide -->
        <div class=imageBox>
          <img alt="QS_Preparing_Data_1_2" width="80%" src="https://gitlab.ub.uni-bielefeld.de/api/v4/projects/1302/repository/files/docs%2Fresource%2Fquickstart%2F1_2.png/raw?ref=clowm-integration-extensions">
        </div>
        <!-- Control panel of this slide-->
        ...
        <!-- Textbox of this slide -->
        <div class=frameBox>
          In this tab, you can inspect and mange your data buckets. 
          For the first execution of this workflow, we want to create a new empty bucket. 
          To do so, click an on the 
      ...
      <div id="QSPD_slide3" class=slide>
        ...
        <div id="QSBucketImage_3" class=imageBox>
          <img alt="QS_Preparing_Data_1_3" width="80%" src="https://gitlab.ub.uni-bielefeld.de/api/v4/projects/1302/repository/files/docs%2Fresource%2Fquickstart%2F1_3.png/raw?ref=clowm-integration-extensions">
        </div>

        <!-- Control pannel of this slide -->
        ...
        <!-- Textbox of this slide -->
        <div class=frameBox>
          The occuring pop-up window allows to select a name for the new bucket. 
          Please notice that this name has to be unique to ensure that the bucket can be identified afterwards. 
      ...
      <div id="QSPD_slide4" class=slide>
        <!-- Image of this slide -->
        <div class=imageBox>
          <img alt="QS_Preparing_Data_1_4" width="80%" src="https://gitlab.ub.uni-bielefeld.de/api/v4/projects/1302/repository/files/docs%2Fresource%2Fquickstart%2F1_4.png/raw?ref=clowm-integration-extensions">
        </div>
        <!-- Control panel of this slide -->
        ...
        <div class=frameBox>
          ...
          At this point, we could start uploading local data into the bucket. 
          However, to sepparate the workflows input and output data, 
          it is usefull to create sepparate folders first.
        </div>
        <br><br><br><br>
      <!-- End of slide 4-->
      </div>
      ...
      <div id="QSPD_slide5" class=slide>
        <!-- Image of this slide -->
        <div class=imageBox>
          <img alt="QSData_1_5" width="80%" src="https://gitlab.ub.uni-bielefeld.de/api/v4/projects/1302/repository/files/docs%2Fresource%2Fquickstart%2F1_4.png/raw?ref=clowm-integration-extensions">
        </div>
        <!-- Control panel of this slide -->
      ...
      <div id="QSPD_slide6" class=slide>
        <!-- Image of this slide -->
        <div class=imageBox>
          <img alt="QSData_1_6" width="80%" src="https://gitlab.ub.uni-bielefeld.de/api/v4/projects/1302/repository/files/docs%2Fresource%2Fquickstart%2F1_5.png/raw?ref=clowm-integration-extensions">
        </div>
      ...
      <div id="QSPD_slide7" class=slide>
        <!-- Image of this slide -->
        <div class=imageBox>
          <img alt="QSData_1_7" width="80%" src="https://gitlab.ub.uni-bielefeld.de/api/v4/projects/1302/repository/files/docs%2Fresource%2Fquickstart%2F1_6.png/raw?ref=clowm-integration-extensions">
        </div>
        <!-- Control panel of this slide -->
        ...
        <!-- Textbox of this slide -->
        <div class="frameBox">
        Repeating this process, we create a folder for the output of the workflow. 
        It is named <em>Quickstart_Output</em> here.
        </div>
      ...
      <div id="QSPD_slide8" class=slide>
        <!-- Image of this slide -->
        <div class=imageBox>
          <img alt="QSData_1_8" width="80%" src="https://gitlab.ub.uni-bielefeld.de/api/v4/projects/1302/repository/files/docs%2Fresource%2Fquickstart%2F1_7.png/raw?ref=clowm-integration-extensions">
        </div>
        <!-- Control panel of this slide -->
      ...
      This button is enabled if the slideshow is currently expanded
          -->
      <span class="inlineBox">
